...
ddkids_vars <- tibble(
    ...
    var_notes_source = c("Diversity Data Kids (25014_1_P_050_5_crowded_housing_race)",
                         "Diversity Data Kids (25106_1_C_050_5_hh_high_housing_costs)"),
    var_label = c("The number of occupied housing units with more than one occupant per room divided by the number of occupied housing units, times 100, for the total population and by race/ethnicity.",
